...
def func():
    ...
    lab2 = Label(wi1, text="Object detection",bg='Black', fg='White',font=('Arial',30)).place(x=910,y=50)
    bt2 = Button(wi1, text="click",font=('Arial',20), command=funct2)
    bt2.place(x=1020,y=110)

    #l3 = Label(wi1, text='').pack()
    lab3 = Label(wi1, text="Gun fire detection",bg='Black', fg='White',font=('Arial',30)).place(x=910,y=200)
    bt3 = Button(wi1, text="click",font=('Arial',20), command=funct3)
    bt3.place(x=1020,y=260)

    lab4 = Label(wi1, text="Distance detection",bg='Black', fg='White',font=('Arial',30)).place(x=910,y=350)
...
# Load a sample picture and learn how to recognize it.
    obama_image = face_recognition.load_image_file("image4.jpg")
